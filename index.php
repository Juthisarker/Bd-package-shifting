  ...
  <div id="introblocks" class="hoc clear"> 
    ...
    <ul class="nospace group">
      <li class="one_quarter first">
         <article><a class="btn" href="rating.php"><i class=  <td><img src="sta.png" alt=""></img></td> </i></a>
		 
          <h4 class="heading underline center"><a href="rating.php">Ratings</a></h4>
        </article>
      </li>
      <li class="one_quarter">
         <article><a class="btn" href="complain.php"><i class=<td><img src="cm.png" alt=""></img></td> </i></a>
		 
          <h4 class="heading underline center"><a href="complain1.php">Complain Desk</a></h4>
        </article>
      </li>
      <li class="one_quarter">
               <article><a class="btn" href="offer.php"><i class=<td><img src="sdf.png" alt=""></img></td> </i></a>
          <h4 class="heading underline center"><a href="offer.php">Offers</a></h4>
        </article>
      </li>
      <li class="one_quarter">
  ...
  <main class="hoc container clear"> 
    ...
    <ul id="home" class="nospace group elements">
      <li class="one_third first">
        <figure class="elementwrapper"><a class="imgoverlay" href="faq.php"><img src="images/demo/faq.png" alt=""></a>
          <figcaption>FAQ</figcaption>
        </figure>
      </li>
      <li class="one_third">
        <figure class="elementwrapper"><a class="imgoverlay" href="contact.php"><img src="images/demo/phone.png" alt=""></a>
